...
**Investor Cap**: The most Investors the Farm may have at once, counted as distinct people across every Venture that is not Settled or Cancelled, the Owner among them — twenty, because twenty in one business for gain is a company under the Companies Act. A Farm Parameter, with a second one beside it for the number at which the Farm starts warning. Neither may be overridden at the moment of signing. _Avoid_: Limit, quota, max investors
...
**Investor Portal**: Where an Investor the Owner has invited reads the Ventures they are in, how each is doing today, and their own three **Investor Statements** — nothing taken, paid or signed through it (ADR 0007). Invited Investors may also see a Venture still gathering capital and say they want to join, and are told how to pay for what they signed by bank; the Agreement is still signed on stamped paper and the capital still arrives at the Venture Account (ADR 0008). By invitation, one person at a time: the Owner hands over a one-time code, and the Investor chooses their own password with their phone number and the code. A code good for a week that nobody took up has run out, and the Owner gives another; one given to somebody already in — a forgotten password — leaves them in meanwhile. The Owner's list says when each was last in, to the hour, and their page the papers they read. The Investor sees their own record back with the NID and bank account mostly hidden — put right by the Owner, never in the portal — chooses a new password and signs other devices out themselves, and is signed in for a working day at a time; every page says the portal is not an offer and moves no money. Their account holds no Role and is not a **Membership**; the Owner takes it away, and the whole portal is closed until the Owner opens it — which is how the farm answers a lawyer who says it is a platform. The Owner's decision of 2026-09-24, taken before the lawyer answered. _Avoid_: Investor login, investor app, dashboard

**Venture Account**: The one bank account, in the Owner's name, that Investors' money moves through: capital in, Venture buying out, what its Animals fetched back in, payouts out. The Farm's own money never passes through it. Every movement is by bank transfer, cheque or deposit slip, never cash. _Avoid_: Escrow (nobody holds it in trust), wallet, fund
