...
**Needs Review**: The flag on an entry the server accepted although the world had changed since it was recorded. Resolved by the Manager; never discarded. _Avoid_: Conflict (reserved for a failed correction), rejected, error
