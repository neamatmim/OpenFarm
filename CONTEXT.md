...
**Reimbursement**: The monthly transfer from a Venture Account to the Farm's, for what that Venture's animals consumed of what the Farm bought for the whole herd: feed, medicine, the Vet's fees for visits that named them, and their share of the month's **Herd Costs**. The Farm buys for everybody; the purse is put right once a month. Charged by who owned each Animal the day she ate it, itemised by Feed Item, medicine and Category so the Owner can read it to an Investor, and taken once per Venture per month once that month is over. Gross, not netted: the Farm's expense when it bought the feed stands, and this income stands beside it. _Avoid_: Recharge, settlement (which is a Venture ending), invoice
