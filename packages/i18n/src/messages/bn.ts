...
export const bn: Record<MessageKey, string> = {
  ...
  "refusal.expectedCalvingNeeded": "গর্ভবতী কেনা বকনার বাচ্চা দেওয়ার তারিখ দিন",
  "refusal.expectedCalvingPassed": "এই তারিখ পার হয়ে গেছে",
  "refusal.expectedCalvingTooFar": "পুরো গর্ভকালের চেয়ে দূরের তারিখ হয় না",
  "refusal.expectedCalvingWithoutPregnancy":
    "শুধু গর্ভবতী গাভীরই বাচ্চা দেওয়ার তারিখ থাকে",
  "refusal.calvingIsDerived":
    "এই তারিখ পাল দেওয়া থেকে হিসাব করা; পাল দেওয়া বা পরীক্ষা ঠিক করুন",
  "refusal.dryOffOfACowNotInMilk": "শুধু দুধের গাভীরই দুধ বন্ধ করা হয়",
  "refusal.noCalvingExpected": "তার বাচ্চা দেওয়ার কোনো তারিখ নেই",
