...
export const bn: Record<MessageKey, string> = {
  ...
  "keep.hint":
    "আরও দুই সপ্তাহ রাখলে লাভ কি না: গত চার সপ্তাহের খাবার আর পশুপালের খরচের ভাগ, এখন যত কেজি বাড়ছে তার ওপর, কেজি-দরের পাশে। যা খরচ হয়ে গেছে তা রাখলেও গেছে, বেচলেও গেছে, তাই এখানে তার কোনো ভূমিকা নেই। ঈদে দাম বদলাবে, সেটা এটি জানে না।",
  "keep.pays": "রাখলে লাভ",
  ...
  "keep.short": "কিছু খাবারের দাম এখনো নেই",
