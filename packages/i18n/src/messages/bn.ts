...
export const bn: Record<MessageKey, string> = {
  ...
  "feed.itemsDescription": "খামারে যা খাওয়ানো হয়। বাদ দিলেও যে রেশনে ছিল সেখানে নাম থেকে যায়।",
  "feed.rationsDescription": "প্রতিটি রেশন একটি পশুর এক দিনের খাবার। কোন পেনে কোনটি চলবে এখানে ঠিক করুন।",
  "feed.targetDescription": "যে পেন বেছে নেবেন, তার এই বেলার খাবার — দাঁড়িয়ে থাকা পশু গুনে হিসাব করা।",
  ...
  "stock.sheetDescription": "কেনা খাবার বা নিজের জমির ফসল গুদামে তুলুন। কেনা হলে দাম টাকার হিসাবে যায়।",
  ...
  "stock.levelHint": "গুদামে এর নিচে নামলে ম্যানেজার ও মালিক জানবেন। খালি রাখলে জানানো হবে না।",
