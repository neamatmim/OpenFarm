...
export const bn: Record<MessageKey, string> = {
  ...
  "home.repeatBreeders": "যে গাভী বারবার পাল দিয়েও গর্ভ ধরছে না",
  "home.failedAttempts": "{count} বার গরমে পাল দিয়ে কাজ হয়নি",
  "home.lastAnswer": "শেষ সিদ্ধান্ত: {decision} — {note}",
  "home.decision": "সিদ্ধান্ত",
  "home.why": "কেন",
  "home.answer": "সিদ্ধান্ত রেকর্ড করুন",
