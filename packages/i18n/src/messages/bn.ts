...
export const bn: Record<MessageKey, string> = {
  ...
  "portal.sums.heldIn": "{count}টি চলমান ভেঞ্চারে",
  "portal.sums.promised": "প্রতিশ্রুত",
  "portal.sums.promisedHint": "আপনার ইউনিটের মোট মূল্য",
  "portal.sums.paidIn": "জমা দিয়েছেন",
