...
export const bn: Record<MessageKey, string> = {
  ...
  "portal.open.countLine": "{count}টি ভেঞ্চারে পুঁজি তোলা হচ্ছে।",
  "portal.open.see": "দেখুন",
  ...
  "portal.request.change": "অনুরোধ বদলান",
  "portal.request.withdraw": "অনুরোধ তুলে নিন",
  "portal.request.sent": "আপনার অনুরোধ পাঠানো হয়েছে",
  ...
  "portal.requests.comesTo": "মোট",
  "portal.requests.askedOn": "অনুরোধের তারিখ",
  "portal.requests.lastChange": "শেষ বদল",
  "portal.requests.yourNote": "আপনার কথা",
  "portal.requests.history": "ইতিহাস",
  "portal.requests.history.made": "{units}টি ইউনিট চেয়েছেন",
  "portal.requests.history.changed": "বদলে {units}টি ইউনিট করেছেন",
  "portal.requests.history.withdrawn": "তুলে নিয়েছেন",
  "portal.requests.history.yes": "খামার আপনার সঙ্গে চুক্তি সই করবে বলেছে",
  "portal.requests.history.no": "খামার বলেছে এবার নয়",
  "portal.requests.history.closed": "বন্ধ হয়েছে",
  ...
  "portal.requests.state.waiting": "খামারের উত্তরের অপেক্ষায়",
  ...
  "portal.request.refused.pastDecideBy":
    "এর সিদ্ধান্তের দিন পেরিয়ে গেছে, তাই আর অনুরোধ নেওয়া হচ্ছে না",
  "portal.request.refused.wrongState": "এই ভেঞ্চারের জন্য আর পুঁজি তোলা হচ্ছে না",
  "portal.request.refused.retired":
    "খামার এখন আপনার অনুরোধ নিতে পারছে না। দয়া করে খামারে ফোন করুন।",
  "portal.request.refused.alreadySigned": "এই ভেঞ্চারে আপনি আগেই চুক্তি সই করেছেন",
  "portal.request.refused.beyondVenture": "এই ভেঞ্চারে এত ইউনিট নেই",
  ...
  "portal.dates.title": "গুরুত্বপূর্ণ তারিখ",
  "portal.dates.signed": "আপনি সই করেছেন",
  ...
  "portal.joinHint":
    "আপনার মোবাইল নম্বর, খামারের মালিক যে কোড দিয়েছেন, আর আপনার নিজের একটি পাসওয়ার্ড দিন।",
  "portal.code": "খামারের দেওয়া কোড",
  "portal.newPassword": "আপনার পাসওয়ার্ড",
  "portal.passwordAgain": "পাসওয়ার্ড আবার",
  "portal.notTheSame": "দুটি পাসওয়ার্ড এক নয়।",
  "portal.join": "পাসওয়ার্ড ঠিক করে সাইন ইন করুন",
  "portal.refused.wrongCode":
    "এই মোবাইল নম্বর আর কোড কোনো আমন্ত্রণের সঙ্গে মেলে না, অথবা কোডের মেয়াদ শেষ। মালিকের কাছে নতুন কোড চান।",
  "portal.refused.closed":
    "বিনিয়োগকারী পোর্টাল খোলা নেই। খামারের মালিকের সঙ্গে কথা বলুন।",
  ...
  "price.col": "দাম ও খরচ",
  "price.cost": "খরচ {cost}",
  "price.breakEven": "কেজি {perKg} হলে খরচ ওঠে",
  "price.margin": "খরচের ওপর {low} থেকে {high}",
  ...
  "keep.hint":
    "আরও দুই সপ্তাহ রাখলে লাভ কি না: গত {days} দিনের খাবার, ওষুধ, ভেট ভিজিট আর পশুপালের খরচের ভাগ, এখন যত কেজি বাড়ছে তার ওপর, কেজি-দরের পাশে। যা খরচ হয়ে গেছে তা রাখলেও গেছে, বেচলেও গেছে, তাই এখানে তার কোনো ভূমিকা নেই। ঈদে দাম বদলাবে, সেটা এটি জানে না।",
  "keep.hintUnset":
    "আরও দুই সপ্তাহ রাখলে লাভ কি না: সম্প্রতি খাবার, ওষুধ, ভেট ভিজিট আর পশুপালের খরচের ভাগ, এখন যত কেজি বাড়ছে তার ওপর, কেজি-দরের পাশে। যা খরচ হয়ে গেছে তা রাখলেও গেছে, বেচলেও গেছে, তাই এখানে তার কোনো ভূমিকা নেই। ঈদে দাম বদলাবে, সেটা এটি জানে না।",
  "keep.pays": "রাখলে লাভ",
  "keep.close": "দামের ওপর নির্ভর",
  "keep.costsMore": "রাখলে লোকসান",
  "keep.over": "আগামী {days} দিনে রাখার খরচের ওপর {over}",
  "keep.ahead": "{gain}, রাখার খরচ {keep}",
  "keep.perKg": "প্রতি কেজি বাড়াতে {perKg}",
  "keep.notGaining": "ওজন বাড়ছে না: {days} দিন রাখতে {keep}",
  "keep.short": "কিছু খাবার বা ওষুধের দাম এখনো নেই",
  "keep.tooNew": "রাখা না বেচা: বলার সময় হয়নি",
  "keep.notFed": "রাখা না বেচা: সম্প্রতি খাওয়ানোর হিসাব নেই",
  "keep.noRate": "রাখা না বেচা: আবার ওজন নিলে বোঝা যাবে",
  "keep.all": "রাখা না বেচা: সব",
  "cull.subtitle":
    "যে গাভীগুলো ছেড়ে দেওয়ার কথা ভাবা যায়, আর কেন। এখানে কিছুই ঠিক করা হয়নি: ছাঁটাই মানেও কসাইয়ের কাছে বিক্রি, বা মৃত্যুর হিসাব লেখা।",
  "cull.reason.milk_short": "দুধে খরচ ওঠে না",
  "cull.reason.open_long": "অনেক দিন গর্ভ নেই",
  "cull.reason.repeat_breeder": "গর্ভ ধরছে না",
  "cull.named": "ছাঁটাই ভাবার মতো",
  "cull.namedHint": "অন্তত একটি কারণ আছে এমন গাভী",
  "cull.milkHint": "গত {days} দিনের দুধের দাম রাখার খরচের চেয়ে কম",
  "cull.milkHintUnset": "সম্প্রতি দুধের দাম রাখার খরচের চেয়ে কম",
  ...
  "cull.notFed": "সম্প্রতি খাওয়ানোর হিসাব নেই",
  "cull.noPrice": "সম্প্রতি দুধ বিক্রি হয়নি, দাম জানা নেই",
  "cull.inCalf": "গর্ভবতী, বাছুর আসবে {day}",
  "cull.sinceCalving": "বাছুর দেওয়ার {days} দিন পর",
  "cull.notInCalf": "গর্ভ নেই",
  "cull.price":
    "দুধের দাম লিটারে {price}: গত {days} দিনে খামারের বিক্রিতে যা পাওয়া গেছে।",
  "cull.unpriced":
    "গত {days} দিনে দুধ বিক্রি হয়নি, তাই কোনো গাভীর দুধ রাখার খরচের পাশে মাপা যাচ্ছে না।",
  "cull.unpricedUnset":
    "সম্প্রতি দুধ বিক্রি হয়নি, তাই কোনো গাভীর দুধ রাখার খরচের পাশে মাপা যাচ্ছে না।",
  "cull.none": "ছাঁটাই ভাবার মতো কোনো গাভী নেই",
  "cull.noneHint":
    "দুধের প্রতিটি গাভী রাখার খরচ তুলছে, যার গর্ভবতী থাকার কথা সে গর্ভবতী, আর কেউ বারবার পাল দিয়েও খালি নেই।",
  "cull.noneInFilter": "এই তালিকায় কোনো গাভী নেই",
  "cull.hint":
    "শুধু আপনার জন্য, আর কখনোই সিদ্ধান্ত নয়: সম্প্রতি তার দুধ আর রাখার খরচ, সে গর্ভবতী কি না, আর গর্ভ ধরছে কি না।",
  ...
  "plan.hint":
    "কী কিনবেন, আর কেজি কত দামে বিক্রি হবে। কেনা শুরুর আগের পরিকল্পনার সঙ্গেই ভেঞ্চার মেলানো হয়; পরের বদলগুলো কারণসহ আলাদা রাখা হয়। শুধু আপনার জন্য।",
  "plan.none": "এখনো কোনো পরিকল্পনা নেই।",
  "plan.write": "পরিকল্পনা লিখুন",
  "plan.change": "পরিকল্পনা বদলান",
  ...
  "plan.total": "মোট",
  "plan.budget": "গরু কেনার বাজেট {budget}",
  "plan.over": "গরু কেনার বাজেটের চেয়ে {over} বেশি",
  "plan.sale": "কেজি {low} থেকে {high} দামে বিক্রি",
  ...
  "plan.deaths": "বিক্রির আগে মারা যেতে পারে (%)",
  "plan.deathsHint":
    "শুধু আনুমানিক হিসাবের কম দিক থেকে বাদ যায়; বেশি দিকে সব পশু বেঁচে থাকে।",
  "plan.deathsOutOfRange": "০ থেকে ৫০-এর মধ্যে",
  "plan.deathsSaid": "বিক্রির আগে {percent} পশু মারা যেতে পারে: কম হিসাবে তা ধরা হয়েছে",
  "plan.reason": "কেন পরিকল্পনা বদলাচ্ছেন",
  "plan.reasonHint":
  ...
  "plan.vs.resultNoProjection":
    "ফলাফল: পরিকল্পনা {plannedLow} থেকে {plannedHigh}; ভেঞ্চার শেষ, তাই আর কোনো অনুমান নেই",
  ...
  "projection.range": "{low} থেকে {high}",
  "projection.profit": "মুনাফা",
  "projection.perUnit": "প্রতি ইউনিট",
  ...
  "projection.switch.hide": "আনুমানিক হিসাব লুকান",
  "projection.switch.shownHint":
    "আমন্ত্রিত বিনিয়োগকারীরা তাঁদের ভেঞ্চারে ও তাঁদের কাছে প্রস্তাবিত ভেঞ্চারে প্রতিটি ভেঞ্চারের আনুমানিক মুনাফা, অনুমান হিসেবে, দেখেন।",
  "projection.switch.hiddenHint":
    "বিনিয়োগকারীরা কোনো আনুমানিক হিসাব দেখেন না। দেখানোর আগে আপনি পোর্টাল প্রিভিউতে তা পড়ে দেখতে পারেন।",
  "projection.switch.confirmTitle": "বিনিয়োগকারীদের আনুমানিক হিসাব দেখাবেন?",
  "projection.switch.confirmWhy":
    "প্রত্যেক আমন্ত্রিত বিনিয়োগকারী আপনার বিক্রয়মূল্যে প্রতিটি ভেঞ্চার কত আয় করতে পারে তা অনুমান হিসেবে দেখবেন। খামারের আইনজীবী ও শরিয়াহ বিশেষজ্ঞ আনুমানিক হিসাব ছাড়াই পোর্টাল অনুমোদন করেছেন: আগে তাঁদের এর ভাষা দেখান।",
  "projection.switch.shownDone": "বিনিয়োগকারীরা এখন আনুমানিক হিসাব দেখছেন",
  "projection.switch.hiddenDone":
    "আনুমানিক হিসাব বিনিয়োগকারীদের কাছ থেকে লুকানো হয়েছে",
  "portal.projection.title": "সম্ভাব্য আয়",
  "portal.projection.notAPromise": "আনুমানিক হিসাব, কোনো প্রতিশ্রুতি নয়",
  "portal.projection.hint":
    "খামারের প্রত্যাশিত বিক্রয়মূল্য, কেজি প্রতি {low} থেকে {high} ({day} তারিখে ঠিক করা), আর বিক্রয়ের সময়ে পশুগুলোর সম্ভাব্য ওজন থেকে হিসাব করা। দাম ওঠানামা করে, পশু মারাও যায়; আপনি যা পাবেন তা হিসাব নিকাশে যা দাঁড়ায় তা-ই।",
  "portal.projection.offerHint":
    "খামারের পরিকল্পনা থেকে হিসাব করা: কেজি প্রতি {buy} দামে {weight} ওজনের পশু কেনা, দিনে {gain} ওজন বৃদ্ধি, আর কেজি প্রতি {low} থেকে {high} দামে বিক্রি ({day} তারিখে ঠিক করা)। দাম ওঠানামা করে, পশু মারাও যায়; প্রতি ইউনিট যা পায় তা হিসাব নিকাশে যা দাঁড়ায় তা-ই।",
  "portal.projection.deaths":
    "কম হিসাবটিতে ধরা হয়েছে {percent} পশু বিক্রির আগে মারা যেতে পারে; বেশি হিসাবটিতে সব পশু বেঁচে থাকে।",
  "portal.projection.yourShare": "মুনাফায় আপনার অংশ",
  "portal.projection.yourPayout": "আপনি যা পেতে পারেন",
  "portal.projection.perUnit": "প্রতি ইউনিটে মুনাফা",
  "portal.projection.loss":
    "কম দামে এটি লোকসান হবে, আর লোকসান আপনার মূলধন থেকে কাটা যায়।",
  "portal.projection.preview":
    "প্রিভিউতে বিনিয়োগকারীরা দেখুন বা না দেখুন আপনি এটি দেখেন: আনুমানিক হিসাব দেখানো বা লুকানো হয় বিনিয়োগকারীদের পাতায়।",
  ...
  "portal.runningBudget": "পরিচালনার বাজেট",
  "portal.budgetLeft": "{of}-এর মধ্যে {left} বাকি",
  "portal.budgetSpent": "{of}-এর মধ্যে {spent} খরচ",
  "portal.papers": "আপনার কাগজ",
  "portal.papersHint": "খামার আপনার জন্য যে কাগজ ছাপে, সেগুলোই — পড়ার ও ছাপার জন্য।",
  ...
  "portal.shutIt": "পোর্টাল বন্ধ করুন",
  "portal.openHint":
    "আপনি যাঁদের আমন্ত্রণ জানিয়েছেন সেই বিনিয়োগকারীরা সাইন ইন করে নিজেদের ভেঞ্চার আর কাগজ পড়তে পারেন। বন্ধ করলে কারও রেকর্ড মোছে না; শুধু প্রবেশ বন্ধ হয়।",
  "portal.shutHint":
    "কোনো বিনিয়োগকারী সাইন ইন করতে পারেন না। খোলার পর প্রত্যেককে তাঁর রেকর্ড থেকে আমন্ত্রণ জানান।",
  "portal.openTitle": "বিনিয়োগকারী পোর্টাল খুলবেন?",
  "portal.openWhy":
    "আপনি যাঁদের আমন্ত্রণ জানাবেন তাঁরা সাইন ইন করে শুধু নিজেদের ভেঞ্চার আর কাগজ পড়তে পারবেন — আর কিছু নয়। খামারের আইনজীবী পোর্টালটি যেমন আছে তেমনই অনুমোদন করেছেন; যে কোনো সময় আবার বন্ধ করতে পারবেন।",
  "portal.opened": "বিনিয়োগকারী পোর্টাল খোলা হয়েছে",
  "portal.shut": "বিনিয়োগকারী পোর্টাল বন্ধ করা হয়েছে",
  "portal.shutForAll": "পোর্টাল সবার জন্য বন্ধ",
  "portal.standing.codeRanOut": "কোডের মেয়াদ শেষ",
  ...
  "portal.standing.none": "আমন্ত্রণ নেই",
  "portal.standing.invited": "আমন্ত্রিত",
  "portal.standing.in": "প্রবেশাধিকার আছে",
  ...
  "portal.codeWhere": "যেখানে কোডটি ব্যবহার করবেন",
  "portal.codeUntil": "মেয়াদ",
  "portal.printLetter": "স্বাগত চিঠি ছাপুন",
  "portal.printLetterHint":
    "স্বাগত চিঠি একবারই দেওয়া হয়: কোড নিচের ছেঁড়া স্লিপে, পেছনের পাতায় «আপনার তথ্য»। এই ঘর বন্ধ করলে আর ছাপা যাবে না।",
  "portal.printSlip": "শুধু কোডের স্লিপ ছাপুন",
  "portal.printSlipHint":
    "চিঠিটি তাঁর কাছে আগেই আছে, তাই শুধু নতুন কোডের স্লিপ। এই ঘর বন্ধ করলে আর ছাপা যাবে না।",
  "portal.refused.noticeUnwritten":
    "চিঠির পেছনের «আপনার তথ্য»-এ খামারের কিছু তথ্য এখনো লেখা হয়নি। «চুক্তির নমুনা» পাতায় «খামারের তথ্য কে রাখে» লিখে আবার ছাপুন — কোড এখনো এখানেই আছে।",
  "portal.refused.letterHandedOver":
    "স্বাগত চিঠি তাঁকে আগেই দেওয়া হয়েছে। এই কোডের জন্য শুধু স্লিপ ছাপুন।",
  "portal.refused.noCodeToHandOver":
    "তাঁর কোনো খোলা কোড নেই। নতুন কোড দিন, আর তা পর্দায় থাকতেই ছাপুন।",
  "portal.takeAway": "প্রবেশাধিকার তুলে নিন",
  "portal.takeAwayTitle": "{name}-এর পোর্টাল প্রবেশাধিকার তুলে নেবেন?",
  "portal.takeAwayWhy":
  ...
  "params.keepAndCullHint":
    "রাখা না বেচা আর ছাঁটাই তালিকার জন্য পশুর রাখার খরচ কত দিন পেছন থেকে ধরা হবে, আর কোন গাভী ছাঁটাই তালিকায় উঠবে। তালিকা দুটো যেমন শুধু আপনার, এগুলোও ঠিক করবেন শুধু আপনি।",
  ...
  "ventures.requests.title": "যোগ দেওয়ার অনুরোধ",
  "ventures.requests.hint":
    "বিনিয়োগকারী পোর্টাল থেকে করা অনুরোধ। অনুরোধে কেউ বাঁধা পড়েন না, কোনো ইউনিটও রাখা হয় না: তা হয় শুধু সই করা চুক্তিতে।",
  "ventures.requests.none": "পোর্টাল থেকে এখনো কেউ যোগ দিতে চাননি",
  "ventures.requests.signed": "সই হয়েছে",
  "ventures.requests.waiting": "চাওয়া হয়েছে, অপেক্ষায়",
  "ventures.requests.target": "তোলা হচ্ছে",
  "ventures.requests.floor": "সর্বনিম্ন সীমা",
  "ventures.requests.unitsAndTaka": "{units}টি ইউনিট · {taka}",
  "ventures.requests.col.when": "চেয়েছেন",
  "ventures.requests.col.note": "কথা",
  "ventures.requests.history": "যা করেছেন",
  "ventures.requests.kind.made": "{units}টি ইউনিট চেয়েছেন",
  "ventures.requests.kind.changed": "বদলে {units}টি ইউনিট করেছেন",
  "ventures.requests.kind.withdrawn": "তুলে নিয়েছেন",
  "ventures.requests.state.waiting": "আপনার উত্তরের অপেক্ষায়",
  "ventures.requests.state.come_and_sign": "এসে সই করুন",
  "ventures.requests.state.not_this_time": "এবার নয়",
  ...
  "investors.dataCopyNoticeUnwritten":
    "«আপনার তথ্য»-এর কথাগুলো এই কাগজের প্রথম পাতা, আর তাতে খামারের কিছু তথ্য এখনো লেখা হয়নি। «চুক্তির নমুনা» পাতায় «খামারের তথ্য কে রাখে» লিখে আবার তৈরি করুন।",
  ...
  "investors.page.onFile": "খাতায়",
  "investors.page.back": "সব বিনিয়োগকারী",
  ...
  "investors.page.agreementsHint":
    "তিনি যত চুক্তিতে সই করেছেন, সর্বশেষটি আগে, আজ যে শর্ত বহাল তা সহ। মূলধন নেওয়া আর পরিশোধ হয় ভেঞ্চারের পাতা থেকে।",
  "investors.page.venture": "ভেঞ্চার",
  "investors.page.signed": "সই",
  "investors.page.capitalHeld": "আছে / প্রতিশ্রুত",
  "investors.page.amendedOn": "সংশোধন {day}",
  "investors.page.acknowledged": "তিনি পেয়েছেন বলেছেন",
  ...
  "auditField.slots": "যে কাজ খোঁজা হয়েছে",
  "audit.raised.onSchedule": "প্লেবুকের সূচি অনুযায়ী {count}টি কাজ",
  "audit.raised.byWhatHappened": "পশুর কোনো ঘটনা থেকে {count}টি কাজ",
  "audit.raised.forTheRenewal": "নিবন্ধন নবায়নের সময় হয়েছে",
  "audit.raised.checked": "খামার দিনের কাজ খুঁজে দেখেছে",
  "audit.raised.byHand": "হাতে তোলা হয়েছে",
  "auditField.raised": "তোলা কাজ",
  "auditField.byTheSchedule": "সূচি অনুযায়ী",
  "auditField.byWhatHappened": "ঘটনা থেকে",
  "auditField.forTheRenewal": "নবায়নের জন্য",
  ...
  "auditField.invitedAt": "আমন্ত্রণের সময়",
  "auditField.acceptedAt": "প্রথম সাইন ইন",
  "auditField.revokedAt": "প্রবেশাধিকার তুলে নেওয়ার সময়",
  ...
  "owner.costsMoreToKeep": "{count}টি রাখলে লোকসান",
  ...
  "templates.notInUse": "ব্যবহার হয় না: প্রতিটি ভেঞ্চার নিজের বিনিয়োগ চুক্তিতে সই হয়",
