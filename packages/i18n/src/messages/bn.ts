...
export const bn: Record<MessageKey, string> = {
  ...
  "keep.hintUnset":
    "আরও কিছু দিন রাখলে লাভ কি না: সম্প্রতি খাবার, ওষুধ, ভেট ভিজিট আর পশুপালের খরচের ভাগ, এখন যত কেজি বাড়ছে তার ওপর, কেজি-দরের পাশে। যা খরচ হয়ে গেছে তা রাখলেও গেছে, বেচলেও গেছে, তাই এখানে তার কোনো ভূমিকা নেই। ঈদে দাম বদলাবে, সেটা এটি জানে না।",
  "keep.pays": "রাখলে লাভ",
