...
export const bn: Record<MessageKey, string> = {
  ...
  "portal.openWhy":
    "আপনি যাঁদের আমন্ত্রণ জানাবেন তাঁরা সাইন ইন করে শুধু নিজেদের ভেঞ্চার আর কাগজ পড়তে পারবেন — আর কিছু নয়। পোর্টাল খামারকে বিনিয়োগ প্ল্যাটফর্ম বানায় কি না, আইনজীবী এখনো জানাননি; যে কোনো সময় আবার বন্ধ করতে পারবেন।",
