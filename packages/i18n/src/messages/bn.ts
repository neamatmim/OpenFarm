...
export const bn: Record<MessageKey, string> = {
  ...
  "projection.hint":
    "আপনার প্রত্যাশিত বিক্রয়মূল্য থেকে আপনার নিজের অনুমান। বিনিয়োগকারীদের পাতায় আনুমানিক হিসাব দেখানো চালু করলে তবেই বিনিয়োগকারীরা এটি দেখেন, আর কোনো কাগজে এটি কখনো ছাপা হয় না।",
  "projection.none": "বিক্রয়মূল্য এখনো ঠিক করা হয়নি।",
  "projection.needsPlan":
    "কেনার পরিকল্পনাও দিন: যে ভেঞ্চারে এখনো মূলধন সংগ্রহ চলছে, তার হিসাব সেটি থেকেই হয়।",
  "projection.set": "দাম ঠিক করুন",
  "projection.change": "দাম বদলান",
  "projection.sheetHint":
    "আপনার অনুমান, বাজারের সাথে বদলায়। প্রতিটি বদল হিসাবের খাতায় থাকে।",
  ...
  "projection.plan": "কেনার পরিকল্পনা",
  "projection.planHint":
    "যে পশু এখনো কেনা বাকি: এই দামে ও ওজনে গরু কেনার বাজেটে যতগুলো হয় ততগুলো কেনা হবে, আর বিক্রয়ের সময় পর্যন্ত প্রতিটির দিনে এতটা ওজন বাড়বে।",
  "projection.buy": "কেনার দাম (কেজি প্রতি ৳)",
  "projection.buyWeight": "কেনার সময় ওজন (কেজি)",
  "projection.dailyGain": "দিনে ওজন বৃদ্ধি (কেজি)",
  "projection.saved": "দাম সংরক্ষণ হয়েছে",
  ...
  "projection.setOn": "ঠিক করা হয়েছে {day}",
