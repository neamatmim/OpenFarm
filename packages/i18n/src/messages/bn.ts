...
export const bn: Record<MessageKey, string> = {
  ...
  "inspector.lot": "লট {lot}",
  "inspector.givenByOnly": "দিয়েছেন {giver}",
  "refusal.lotNumberMissing":
    "এটি টিকা: আগে দফার লট নম্বর লিখুন, নয়তো এই ডোজের নিজের",
  ...
  "sop.effect.vaccine_lot": "ভায়ালের লট নম্বর, পুরো দফায় একবার",
