...
export const bn: Record<MessageKey, string> = {
  ...
  "backups.subtitle": "খামারের রেকর্ড এই মেশিনের বাইরে কপি হচ্ছে কিনা, আর খামারের নিজের ঘড়ি চলছে কিনা।",
  "schedule.lastRan": "খামারের সময়সূচি শেষ চলেছে {when}",
  "schedule.notYet": "সার্ভার চালু হওয়ার পর খামারের সময়সূচি এখনো চলেনি",
  "schedule.what": "প্রতি পাঁচ মিনিটে সার্ভার দিনের কাজ তোলে, দেরি হওয়া কাজ ও উইথড্রয়াল শেষ হওয়ার খবর দেয়, আর সারসংক্ষেপ পাঠায়।",
