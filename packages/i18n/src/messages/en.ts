...
export const en = {
  ...
  "intake.groupTripHint": "What the day cost beyond the animals themselves. Write it up once; every animal that came home on the lorry carries an equal share.",
  ...
  "intake.tripRecorded": "The outing is written up, and this arrival came home on it",
