...
export const en = {
  ...
  "feed.subtitle": "What is in the store, what came in, and which Ration each Pen is on.",
  ...
  "feed.itemsDescription": "What the farm feeds. A retired Feed Item stays named in the Rations that fed it.",
  "feed.rationsDescription": "Each Ration is one animal's day. Choose here which Pen is on which.",
  "feed.targetDescription": "This session's feed for the Pen you choose, worked out from the animals standing in it.",
  ...
  "stock.sheetDescription": "Put feed bought, or cut from the farm's own land, into the store. A purchase's price goes to the money register.",
  ...
  "stock.levelHint": "The Manager and the Owner are told when the store falls below this. Leave it blank to not be told.",
