...
export const en = {
  ...
  "money.from.entry": "Entered by hand",
  "entry.title": "Enter money",
  "entry.category": "Category",
  "entry.in": "in",
  "entry.out": "out",
  "entry.amount": "Amount (৳)",
  "entry.on": "Day",
  "entry.counterparty": "Paid to or received from",
  "entry.worker": "Who the wage is for",
  "entry.wageMonth": "Month the wage pays for",
  "entry.note": "Note",
  "entry.receipt": "Receipt photo",
  "entry.save": "Enter it",
  "entry.entered": "Entered",
  "entry.categories": "Categories",
  "entry.retire": "Retire",
  "entry.newCategory": "New Category",
  "entry.direction": "In or out",
  "entry.addCategory": "Add",
  "entry.showReceipt": "Receipt",
  "entry.wageFor": "wage for {month}",
