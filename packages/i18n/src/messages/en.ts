...
export const en = {
  ...
  "abortion.title": "Pregnancies lost",
  ...
  "home.repeatBreeders": "Cows that will not settle",
  "home.failedAttempts": "{count} heats served that did not take",
  "home.lastAnswer": "Last decided: {decision} — {note}",
  "home.decision": "Decision",
  "home.why": "Why",
  "home.answer": "Record the decision",
