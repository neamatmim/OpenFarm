...
export const en = {
  ...
  "inspector.lot": "Lot {lot}",
  "inspector.givenByOnly": "Given by {giver}",
  "refusal.lotNumberMissing":
    "This is a vaccine: write the run's Lot Number first, or this dose's own",
  ...
  "sop.effect.vaccine_lot": "The vial's Lot Number, once for the run",
