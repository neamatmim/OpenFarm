...
CREATE UNIQUE INDEX "ration_pen_uidx" ON "ration" ("pen_id");--> statement-breakpoint
...
ALTER TABLE "ration" ADD CONSTRAINT "ration_pen_id_pen_id_fkey" FOREIGN KEY ("pen_id") REFERENCES "pen"("id") ON DELETE CASCADE;--> statement-breakpoint
