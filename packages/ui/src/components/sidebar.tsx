...
import { Separator } from "@OpenFarm/ui/components/separator";
import {
  Sheet,
  SheetContent,
  SheetHeader,
...
import {
  ...
  TooltipContent,
  TooltipTrigger,
} from "@OpenFarm/ui/components/tooltip";
...
function Sidebar({
  ...
  /** The name a screen reader gives the sidebar when it slides over a phone, in the reader's language. */
  mobileTitle?: string;
}) {
...
function SidebarGroupLabel({
  ...
  return useRender({
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          "text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-sm outline-hidden transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
          className
        ),
      },
      props
