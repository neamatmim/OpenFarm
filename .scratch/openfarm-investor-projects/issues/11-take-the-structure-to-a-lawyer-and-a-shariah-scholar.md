...
**Task (HITL).** The Owner takes the decided structure to a Bangladeshi lawyer and a Shariah scholar, and brings back written answers. The structure ([the legal-form ticket](./10-the-legal-form-and-shariah-structure.md)) is: **mudarabah**, the Owner as mudarib signing a separate stamped Investment Agreement with each Investor, one per project; **at most 20 Investors** across all running projects; a known circle resident in Bangladesh, no advertising or referrals; **bank channels only** through a dedicated Venture Account; the Owner's own capital treated as an Investor's; the software an internal ledger and statement printer. The contract terms can't be settled on guesses about the law.
