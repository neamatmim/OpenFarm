...
**Task (HITL).** Ticket 11 of the investor-projects map, [Take the structure to a lawyer and a Shariah scholar](../../openfarm-investor-projects/issues/11-take-the-structure-to-a-lawyer-and-a-shariah-scholar.md), asks only "would a future investor login?" be a platform. The portal now exists. So the Owner brings the lawyer the portal as it actually is:
...
- [x] **Upcoming Ventures:** may the portal show a Venture still gathering capital to the farm's existing Investors only, and let them say they are interested? Or is that an offer of investment made online, which undoes the closed-circle, no-advertising footing and bears on the BSEC question?
- [x] **How to pay:** may the portal show the Venture Account's bank details and the reference to use, for capital an Investor has already signed a stamped Agreement for? They would pay from their own bank, and the Owner would record it as now. Is that information about their own contract, or a payment channel?
- [x] **Paying inside the portal:** would taking an Investor's payment in the portal (card, mobile financial services, a payment gateway) make OpenFarm a payment system needing Bangladesh Bank approval (PSS Act 2024 s.15(2))? Can it be squared with bank channels only, through the Venture Account, and with "no capital without a stamped Agreement"?
...
**The shape of joining, designed 2026-09-25, for the written opinion to cover.** The verbal answer was to general questions; these are the screens it now has to cover. The terms are in CONTEXT.md's **Request to Join**, **Pay-in Code**, **Investor Portal** and **Venture Account** entries.

- [x] **What is shown of an open Venture:** only one the Owner chose to show, to every invited Investor. It shows the terms, including the split the farm signs on today, the refund and loss rules, and a few words of the Owner's. It shows no projection, no past result, no "Units left" and nobody else's business. Is the Owner's own description a risk, even with the warning where they write it?
- [x] **The notice on every page** changes from "not an offer to invest" to roughly: "This is not a public offer. Joining is only by an Agreement signed in person with the farm, and no money moves through this portal." What exact words does the lawyer want?
- [x] **A Request to Join** records whole Units and a note, and binds nobody. The Owner answers "come and sign" or "not this time". Does a recorded "come and sign" risk reading as an acceptance, forming a contract before the stamped paper?
- [x] **The bank details** show only on the Investor's own signed Agreement, never beside an open Venture. They come with the amount still owed, a Pay-in Code, the decide-by day, and "the farm will never ask you to pay anywhere else". Is that the line the lawyer meant?
...
## The written opinion (2026-09-26)

**In hand, and no changes needed.** The lawyer approved the portal as built:
- by invitation, read-only;
- with Ventures raising capital shown to invited Investors, and Requests to Join;
- how to pay, shown on a signed Agreement;
- the notice, the Portal Consent, «আপনার তথ্য», the Agreement's data clause and several Nominees.

**Paying inside the portal stays out**, as the verbal answer said.

**What this changes:** the portal may now be opened to real Investors, one at a time, by the Owner's switch and invitation. The Owner records the lawyer's approval on each wording Version from the Templates page.
