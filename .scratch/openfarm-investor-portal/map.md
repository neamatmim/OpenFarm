...
- **Joining a Venture and paying through the portal**, meaning an upcoming Venture shown with a way to join, and capital paid inside the portal. Asked by the Owner on 2026-09-25 and held back. It would be an offer made online and a payment channel: exactly what ADR 0007 and the legal footing rule out ("nothing is taken, paid, signed or offered through it"). The three questions are on [Bring the portal as built to the lawyer](./issues/07-bring-the-portal-to-the-lawyer.md) and on ticket 11. If the answers allow it, it is a fresh effort that reopens ADR 0007 on purpose.
