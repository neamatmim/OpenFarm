...
- The age _public_ key lives in the environment and is public by design; the private half lives in the password manager and nowhere else, because it is the only thing that can read a backup.
