...
- Also: a second sweep could tell somebody the same thing twice, because what was pushed was built from what was *intended* rather than from what was actually written; the worker announced English words as Bangla; a malformed key would have failed every request in the process rather than simply not pushing; and declining the permission was raised as an error to the person declining it.
