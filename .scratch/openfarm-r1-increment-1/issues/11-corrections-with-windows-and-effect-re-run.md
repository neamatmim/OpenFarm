...
- **A Vet had an unlimited window over the milking book.** The decision doc gives the Vet their unlimited window over _health entries_ — a Diagnosis, a Prescription, a dose they gave. Health arrives in increment 3; until then there is no such entry, and being a Vet is not a licence over the milking book. The test that asserted otherwise was the bug, written down.
