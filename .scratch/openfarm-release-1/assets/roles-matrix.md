...
- **The Owner does the Manager's work** (Owner, 2026-09-17, superseding the line above and every Owner cell narrower than the Manager's): the Owner may do anything the Manager may — record feed in and the low-stock level, Dispatches, Intakes, Sales, medicine bought and products added, money by hand, Service, Calving and Stock Count steps, answer a Repeat Breeder. Money the Owner books needs no approval of theirs, and the Owner may sign off work they did themselves; nobody else may. The Vet's clinical acts — Diagnosis, Prescription, withdrawal days, shortening a Withdrawal, Pregnancy Check, Abortion — stay the Vet's.
