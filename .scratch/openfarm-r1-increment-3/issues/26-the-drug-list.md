...
- **Half a Withdrawal got through.** Adding a product with only the milk days filled slipped past the Vet check entirely, because the check asked whether _both_ were given: the farm ended up with a withdrawal figure nobody was recorded as having written. Both or neither, and the refusal says why.
