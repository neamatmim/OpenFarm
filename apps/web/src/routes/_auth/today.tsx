...
const WorkCard = ({
  ...
  return (
    <Link
      className={cn(
        "group bg-card hover:border-primary/40 focus-visible:ring-ring flex min-h-24 items-center gap-3 rounded-xl border p-4 shadow-[0_1px_2px_0_oklch(0.2_0.02_160/0.05)] transition-[border-color,box-shadow] duration-150 outline-none hover:shadow-md focus-visible:ring-2 sm:gap-4",
